...
(() => {
  ...
  function u(e) {
    ...
    if (!r) throw new s('add-to-cache-list-unexpected-type', { entry: e });
    if (!t) {
  ...
  class R {
    ...
    async cacheMatch(e) {
      ...
      const { cacheName: n, matchOptions: s } = this._strategy,
        ...
        i = Object.assign(Object.assign({}, s), { cacheName: n });
    ...
    async cachePut(e, t) {
      ...
      if (!t) throw new s('cache-put-with-no-response', { url: y(n.url) });
        ...
        u = h
          ? await (async function (e, t, r, n) {
              ...
              const a = Object.assign(Object.assign({}, n), {
                ...
                i = await e.keys(t, a);
              for (const t of i) if (s === g(t.url, r)) return e.match(t, n);
      ...
      for (const t of this._strategy.plugins)
        if ('function' == typeof t[e]) {
          const r = this._pluginStateMap.get(t),
            n = (n) => {
              const s = Object.assign(Object.assign({}, n), { state: r });
              return t[e](s);
            };
          yield n;
        }
  ...
  class C {
    ...
    handleAll(e) {
      ...
      const t = e.event,
        ...
        s = new R(this, { event: t, request: r, params: n }),
        a = this._getResponse(s, r, t);
      ...
      try {
        ...
        if (s instanceof Error)
          for (const a of e.iterateCallbacks('handlerDidError'))
            if (((n = await a({ error: s, event: r, request: t })), n)) break;
        if (!n) throw s;
      }
      for (const s of e.iterateCallbacks('handlerWillRespond'))
        n = await s({ event: r, request: t, response: n });
      return n;
    }
    ...
    _useDefaultCacheabilityPluginIfNeeded() {
      ...
      for (const [r, n] of this.plugins.entries())
        n !== x.copyRedirectedCacheableResponsesPlugin &&
          (n === x.defaultPrecacheCacheabilityPlugin && (e = r),
          n.cacheWillUpdate && t++);
      0 === t
  ...
  class P {
    ...
    handleRequest({ request: e, event: t }) {
      ...
      let c;
      try {
        c = i.handle({ url: r, request: e, event: t, params: s });
      } catch (e) {
        c = Promise.reject(e);
      }
  ...
  function O(e, t, r) {
    ...
    if ('string' == typeof e) {
      ...
      0;
      n = new E(({ url: e }) => e.href === s.href, t, r);
    } else if (e instanceof RegExp) n = new L(e, t, r);
    else if ('function' == typeof e) n = new E(e, t, r);
    else {
      if (!(e instanceof E))
  ...
  function I() {
          ...
          (function (t, r, n) {
            ...
            return function (a, i) {
              ...
              for (n.method = a, n.arg = i; ; ) {
                ...
                var h = u(t, r, n);
                if ('normal' === h.type) {
                  if (((s = n.done ? 4 : 2), h.arg === l)) continue;
                  return { value: h.arg, done: n.done };
                }
                'throw' === h.type &&
                  ((s = 4), (n.method = 'throw'), (n.arg = h.arg));
              }
            };
          })(t, n, new x(s || [])),
          !0
    ...
    var m = (p.prototype = f.prototype = Object.create(y));
    function v(e) {
    ...
    function b(t, r) {
      ...
      var a = u(s, t.i, r.arg);
      if ('throw' === a.type)
        return (r.method = 'throw'), (r.arg = a.arg), (r.delegate = null), l;
      var i = a.arg;
      return i
        ? i.done
          ? ((r[t.r] = i.value),
      ...
      if (null != t) {
        ...
        if (!isNaN(t.length)) {
          var s = -1,
            i = function r() {
              for (; ++s < t.length; )
                if (n.call(t, s)) return (r.value = t[s]), (r.done = !1), r;
    ...
    return (
      ...
      c(m, 'constructor', p),
      c(p, 'constructor', d),
      (d.displayName = c(p, o, 'GeneratorFunction')),
      ...
      (x.prototype = {
        ...
        dispatchException: function (t) {
          ...
          for (var s = r.tryEntries.length - 1; s >= 0; --s) {
            ...
            if (null != a[0] && a[0] <= o) {
              if (o < c)
                return (this.method = 'next'), (this.arg = e), n(c), !0;
              if (o < h) return n(h), !1;
            }
          }
        },
        abrupt: function (e, t) {
          ...
          return (
            ...
            (a.arg = t),
            s
              ? ((this.method = 'next'), (this.next = s[2]), l)
              : this.complete(a)
          );
        },
        ...
        finish: function (e) {
          for (var t = this.tryEntries.length - 1; t >= 0; --t) {
            ...
            if (r[2] === e) return this.complete(r[4], r[3]), C(r), l;
          }
        },
        catch: function (e) {
          for (var t = this.tryEntries.length - 1; t >= 0; --t) {
  ...
  (function (e) {
    ...
    },
    {
      ...
      url: '/Story-app/asset/icons/favicon.png',
    },
    {
    ...
    {
      revision: 'fa4753f784c0681ffa11bd401a8eda17',
    ...
    { revision: null, url: '/Story-app/main.2f7395fa44f7469b94cd.js' },
    {
      revision: '617fd376435e7230f7d7a2c482065b3f',
      url: '/Story-app/main.2f7395fa44f7469b94cd.js.LICENSE.txt',
    },
    { revision: null, url: '/Story-app/main.d36a62a1a90eaf209938.css' },
    {
      revision: '3cfdb2b6a2a87bcc530c4d81028b12b8',
    ...
    O(
      ...
      new (class extends C {
        ...
        async _getNetworkPromise({
          ...
          return (
            e && clearTimeout(e), (!s && a) || (a = await n.cacheMatch(t)), a
          );
        }
      })()
    ),
    O(
      ...
      new (class extends C {
        async _handle(e, t) {
          ...
          if (!n) throw new s('no-response', { url: e.url, error: r });
          return n;
        }
      })({
        cacheName: 'images',
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (r = t.response),
                            e.abrupt('return', 200 === r.status ? r : null)
                          );
                        case 2:
                        case 'end':
                          return e.stop();
  ...
  (D = (function () {
          ...
          for (;;)
            switch ((e.prev = e.next)) {
              case 0:
                ...
                return e.abrupt('return', caches.match(G));
              case 3:
                return e.abrupt('return', Response.error());
              case 4:
              case 'end':
                return e.stop();
            }
    ...
    self.addEventListener('push', function (e) {
      var t,
        r = (null === (t = e.data) || void 0 === t ? void 0 : t.json()) || {},
        n = r.title || 'New Story!',
        s = {
          body: r.body || 'A new story is available. Check it out!',
          icon: ''.concat(self.registration.scope, 'asset/icons/logo.png'),
          badge: ''.concat(self.registration.scope, 'asset/icons/logo.png'),
        };
      e.waitUntil(self.registration.showNotification(n, s));
    });
})();
