/*! For license information please see main.99aaf452d6794b79f431.js.LICENSE.txt */
(() => {
  'use strict';
  var t,
    e = {
      259: (t, e, n) => {
          ...
          c =
            ((o = {
              ...
              loadSession: function () {
                ...
                return t && e && n ? { token: t, name: e, email: n } : null;
              },
        ...
        var v = 'https://story-api.dicoding.dev/v1',
          h = (function () {
                              ...
                              switch (t.n) {
                                ...
                                case 5:
                                  return (
                                    (t.p = 5),
                                    (i = t.v),
                                    console.error('Login Error:', i.message),
                                    t.a(2, !1)
                                  );
                              }
                          },
                              ...
                              switch (t.n) {
                                ...
                                case 6:
                                  return (
                                    (t.p = 6),
                                    (a = t.v),
                                    console.error('Register Error:', a.message),
                                    t.a(2, !1)
                                  );
                              }
                          },
          ...
          function p(t) {
            return (
              Object.setPrototypeOf
                ...
                : ((t.__proto__ = s), g(t, o, 'GeneratorFunction')),
          ...
          return (function (t, e, n) {
            ...
            [
              ...
              },
              {
                ...
                value:
                  ((t = S(
                    b().m(function t(e, n, r) {
                      return b().w(
                        function (t) {
                          for (;;)
                            switch (t.n) {
                              case 0:
                                return (t.n = 1), h.register(e, n, r);
                              case 1:
                                t.v
              ...
              },
              {
                key: 'logout',
                value: function () {
                  h.logout(), this.view.navigateToLogin();
                },
              },
              {
                key: 'isAuthenticated',
                              ...
                              .addEventListener('submit', function (e) {
                                ...
                                n.length < 2
                                  ...
                                  ? o.length < 8
                                    ...
                                    : t.presenter.handleRegister(n, r, o)
                ...
                for (;;)
                  if (0 === t.n)
                    return t.a(
                      ...
                      (0, B.P2)('story-db', 1, {
                        upgrade: function (t) {
                          t.objectStoreNames.contains(D) ||
                            t.createObjectStore(D, { keyPath: 'id' });
                        },
                      })
                    );
              }, t);
                ...
                return M().w(
                  function (e) {
                    for (;;)
                      switch (e.n) {
                        case 0:
                          return (e.p = 0), (e.n = 1), H();
                        case 1:
                          return (n = e.v), (e.n = 2), n.put(D, t);
                        case 2:
                          console.log('✅ Story saved:', t.id), (e.n = 4);
                          break;
                        case 3:
                          (e.p = 3),
                            (r = e.v),
                            console.error('❌ Failed to save story:', r);
                        case 4:
                          return e.a(2);
                      }
                  },
                ...
                return M().w(
                  function (t) {
                    for (;;)
                      switch (t.n) {
                        case 0:
                          return (t.p = 0), (t.n = 1), H();
                        case 1:
                          return (e = t.v), (t.n = 2), e.getAll(D);
                        case 2:
                          return (
                            (n = t.v),
                            t.a(
                        ...
                        case 3:
                          return (
                            (t.p = 3),
                            (r = t.v),
                            console.error('❌ Failed to get local stories:', r),
                            t.a(2, [])
                          );
                      }
                  },
                    ...
                    for (;;)
                      switch (e.n) {
                        case 0:
                          return (e.p = 0), (e.n = 1), H();
                        case 1:
                          return (n = e.v), (e.n = 2), n.delete(D, t);
                        case 2:
                          console.log(
                    ...
                    for (;;)
                      switch (t.n) {
                        case 0:
                          return (t.p = 0), (t.n = 1), H();
                        case 1:
                          return (e = t.v), (t.n = 2), e.clear(D);
                        case 2:
                          console.log('🚮 All stories cleared'), (t.n = 4);
                          break;
                        case 3:
                          (t.p = 3),
                            (n = t.v),
                            console.error('❌ Failed to clear stories:', n);
                        case 4:
                          return t.a(2);
                      }
                  },
        ...
        var et = 'https://story-api.dicoding.dev/v1',
          nt = 'cachedStories',
          rt = (function () {
            return (function (t, e, n) {
              return (
                              ...
                              switch (t.n) {
                                ...
                                case 4:
                                  return (
                                    ...
                                    localStorage.setItem(nt, JSON.stringify(i)),
                                    t.a(2, i)
                                  );
                                case 5:
                                  return (
                                ...
                                case 7:
                                  return (
                                    (c =
                                      JSON.parse(localStorage.getItem(nt)) ||
                                      []),
                                    t.a(2, c)
                                  );
                              }
                            ...
                            for (;;)
                              switch (t.n) {
                                ...
                                case 3:
                                  ...
                                  throw new Error(
                                    l.message || 'Failed to add data'
                                  );
                                case 4:
                                  return (
                                    (f = {
                                      id:
                                        (null === (u = l.story) || void 0 === u
                                          ? void 0
                                          : u.id) || Date.now(),
                                      description: n,
                                      image: null,
                                    ...
                                    (p =
                                      JSON.parse(localStorage.getItem(nt)) ||
                                      []).push(f),
                                    localStorage.setItem(nt, JSON.stringify(p)),
                                    (t.n = 5),
                                    J(f)
                                  );
                                case 5:
                                ...
                                case 6:
                                  throw (
                                    ((t.p = 6),
                                    (d = t.v),
                                    console.error('Add Story Error:', d),
        ...
        function it() {
          ...
          function p(t) {
            return (
              Object.setPrototypeOf
                ? Object.setPrototypeOf(t, s)
                : ((t.__proto__ = s), at(t, o, 'GeneratorFunction')),
              (t.prototype = Object.create(f)),
              t
            );
          }
            ...
            return (function (t, e, n) {
              ...
              [
                ...
                },
                {
                  key: 'logout',
                  value: function () {
                    h.logout(), this.view.redirectToLogin();
                  },
                },
                {
                        ...
                        return it().w(
                          function (t) {
                            for (;;)
                              switch (t.n) {
                                case 0:
                                  return (t.p = 0), (t.n = 1), rt.getStorys();
                                case 1:
                                  (e = t.v),
                                    this.view.renderStorys(e),
                                    this.view.showMap(e),
                                    (t.n = 3);
                                  break;
                                case 2:
        ...
        function vt(t) {
          ...
          throw new TypeError(yt(t) + ' is not iterable');
        }
        function ht(t, e) {
          var n = Object.keys(t);
        ...
        function St() {
          ...
          function p(t) {
            return (
              Object.setPrototypeOf
                ? Object.setPrototypeOf(t, s)
                : ((t.__proto__ = s), kt(t, o, 'GeneratorFunction')),
              (t.prototype = Object.create(f)),
              t
            );
          }
            ...
            return (function (t, e, n) {
              ...
              [
                            ...
                            for (;;)
                              switch (t.n) {
                                case 0:
                                  ...
                                  return this.redirectToLogin(), t.a(2);
                                case 1:
                                  return (t.n = 2), q();
                                case 2:
                                  return (
                                    (e = t.v.map(function (t) {
                                      return t.id;
                                    })),
                ...
                },
                {
                  key: 'showMap',
                  value: function (t) {
                    var e = document.getElementById('global-map');
                    if (e && 0 !== t.length) {
                      e._leaflet_id && (e._leaflet_id = null);
                      ...
                      if (n) {
                        var r = L.map('global-map').setView(
                    ...
                    n &&
                      ...
                      null === (t = document.getElementById('logout-btn')) ||
                        ...
                        t.addEventListener('click', function (t) {
                          t.preventDefault(), e.presenter.logout();
                        }));
                  },
                },
                {
                ...
                {
                  key: 'getSavedStoryIds',
                  value: function () {
                    return (
                      JSON.parse(localStorage.getItem('savedStoryIds')) || []
                    );
                  },
                },
                {
                  key: 'saveStoryId',
                  value: function (t) {
                    var e = this.getSavedStoryIds();
                    e.includes(t) ||
                      (e.push(t),
                      localStorage.setItem('savedStoryIds', JSON.stringify(e)));
                  },
                },
                {
                  key: 'removeStoryId',
                  value: function (t) {
                    var e = this.getSavedStoryIds().filter(function (e) {
                      return e !== t;
                    });
                    localStorage.setItem('savedStoryIds', JSON.stringify(e));
                  },
                },
                {
                  key: 'isStorySaved',
                  value: function (t) {
                    return this.getSavedStoryIds().includes(t);
                  },
                },
                {
                  key: 'showError',
              ...
              [
                              ...
                              switch (e.n) {
                                case 0:
                                  return (
                                    ...
                                    (o = this),
                                    (e.n = 1),
                                    Ht(Yt, this, Kt).call(this)
                                  );
                                case 1:
                                  return (
                                    (i = e.v),
                                    n(r, o, i),
                                    t.addNewStream(Ut(Wt, this)),
                                    (Ut(Jt, this).srcObject = Ut(Wt, this)),
                                    (e.n = 2),
                                    Ut(Jt, this).play()
                                  );
                                case 2:
                                  Ht(Yt, this, Xt).call(this);
                                case 3:
                                  return e.a(2);
                              }
                          },
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    n &&
                      (Dt(zt, this, n),
                      Ut(zt, this).addEventListener(
                        'click',
                        Nt(
                          xt().m(function t() {
                            return xt().w(function (t) {
                              for (;;)
                                switch (t.n) {
                                  case 0:
                ...
                },
                {
                  key: 'takePicture',
                  value: function () {
                    var t = Ut(Vt, this).getContext('2d'),
                      e = Ut(Jt, this).videoWidth,
                      n = Ut(Jt, this).videoHeight;
                    return e && n
                      ? ((Ut(Vt, this).width = e),
                        (Ut(Vt, this).height = n),
                        t.drawImage(Ut(Jt, this), 0, 0, e, n),
                        Ut(Vt, this).toDataURL('image/jpeg'))
                      : null;
                  },
                },
              ],
                ...
                xt().m(function e() {
                  return xt().w(function (e) {
                    for (;;)
                      switch (e.n) {
                        case 0:
                          return Tt.stopAllStreams(), (e.n = 1), t.launch();
                        case 1:
                          return e.a(2);
                      }
                  }, e);
        ...
        function Xt() {
          var t = Ut(Vt, this).getContext('2d');
          (t.fillStyle = '#ccc'),
            t.fillRect(0, 0, Ut(Vt, this).width, Ut(Vt, this).height);
        }
        function te() {
          var t,
            e,
          ...
          function p(t) {
            return (
              Object.setPrototypeOf
                ? Object.setPrototypeOf(t, s)
                : ((t.__proto__ = s), ee(t, o, 'GeneratorFunction')),
              (t.prototype = Object.create(f)),
              t
            );
          }
          return (
            ...
            ee(s, 'constructor', u),
            (u.displayName = 'GeneratorFunction'),
            ee(s, o, 'GeneratorFunction'),
            ee(f),
            ee(f, o, 'Generator'),
            ee(f, r, function () {
              return this;
            }),
            ee(f, 'toString', function () {
              return '[object Generator]';
            }),
            (te = function () {
              return { w: i, m: p };
        ...
        var oe = {
          ...
          afterRender: function () {
            ...
            return re(
              te().m(function e() {
                var n;
                return te().w(function (e) {
                  for (;;)
                    switch (e.n) {
                      case 0:
                        if (
                          ((t.presenter = new ft(t)),
                          t.presenter.isAuthenticated())
                        ) {
                          e.n = 1;
                          break;
                        }
                        return t.redirectToLogin(), e.a(2);
                      case 1:
                        t.renderMap(),
                          t.initCamera(),
                          t.handleSubmit(),
          ...
          renderMap: function () {
            ...
            var e,
              n = L.map('map').setView([-6.2, 106.816666], 10);
            L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
              ...
              n.on('click', function (r) {
                ...
                (document.getElementById('latitude').value = i),
                  ...
                  e ? e.setLatLng(r.latlng) : (e = L.marker(r.latlng).addTo(n)),
                  t.updatePopup(e),
                  n.setView(r.latlng, n.getZoom());
              }),
              document
          ...
          updatePopup: function (t) {
            if (t) {
              var e =
                ...
                'Tanpa Deskripsi';
              t.bindPopup('<strong>'.concat(e, '</strong>')).openPopup();
            }
          },
          initCamera: function () {
            var t = document.getElementById('open-camera'),
              e = document.getElementById('take-photo'),
              n = document.getElementById('camera-stream'),
              r = document.getElementById('snapshot'),
              o = document.getElementById('image'),
              i = new $t({ video: n, canvas: r });
            t.addEventListener(
              'click',
              re(
                te().m(function t() {
                      ...
                      for (;;)
                        switch (e.n) {
                          ...
                          case 1:
                            ...
                            return e.a(2, alert('Please take a photo first.'));
                          case 2:
                            if (i && a) {
                              e.n = 3;
                              break;
                          ...
                          case 5:
                            if ((dt(), 'granted' !== Notification.permission)) {
                              e.n = 7;
                              break;
                            }
                            return (e.n = 6), navigator.serviceWorker.ready;
                          case 6:
                            e.v.showNotification('🎉 Story added!', {
        ...
        function ie() {
          ...
          function p(t) {
            return (
              Object.setPrototypeOf
                ? Object.setPrototypeOf(t, s)
                : ((t.__proto__ = s), ae(t, o, 'GeneratorFunction')),
              (t.prototype = Object.create(f)),
              t
            );
          }
          return (
            ...
            ae(s, 'constructor', u),
            (u.displayName = 'GeneratorFunction'),
            ae(s, o, 'GeneratorFunction'),
            ae(f),
            ae(f, o, 'Generator'),
            ae(f, r, function () {
              return this;
            }),
            ae(f, 'toString', function () {
              return '[object Generator]';
            }),
            (ie = function () {
              return { w: i, m: p };
                ...
                return ie().w(function (e) {
                  for (;;)
                    switch (e.n) {
                      case 0:
                        return (
                          (r = document.getElementById('story-list')),
                          (e.n = 1),
                          q()
                        );
                      case 1:
                        if (
                          ((o = e.v), (r.innerHTML = ''), o && 0 !== o.length)
                        ) {
                          e.n = 2;
                          break;
                        }
                        return (
                          (r.innerHTML = '<p>No stories saved offline.</p>'),
                          e.a(2)
                        );
                      case 2:
                        o.forEach(function (e) {
                          var n = document.createElement('article');
                          n.className = 'story-card horizontal-card';
                          var o = document.createElement('img');
                          if (((o.alt = 'Story photo'), e.imageBlob)) {
                            var i = URL.createObjectURL(e.imageBlob);
                            (o.src = i),
                              (o.onload = function () {
                                return URL.revokeObjectURL(i);
                              });
                          } else e.image && '[uploaded]' !== e.image && (o.src = e.image);
                          var a = document.createElement('div');
                          (a.className = 'story-content'),
                            (a.innerHTML = '\n        <p>'
                              .concat(
                                e.description,
                          ...
                          (c.className = 'delete-btn'),
                            ...
                            c.addEventListener(
                              ...
                              ue(
                                ie().m(function n() {
                                  return ie().w(function (n) {
                                    for (;;)
                                      switch (n.n) {
                                        case 0:
                                          return (n.n = 1), V(e.id);
                                        case 1:
                                          se(e.id), t.afterRender();
                                        case 2:
                                          return n.a(2);
                                      }
                                  }, n);
                          ...
                          null ===
                            (n = document.getElementById('clear-all-btn')) ||
                            void 0 === n ||
                            n.addEventListener(
                              'click',
                              ue(
        ...
        function fe() {
          ...
          function p(t) {
            return (
              Object.setPrototypeOf
                ? Object.setPrototypeOf(t, s)
                : ((t.__proto__ = s), pe(t, o, 'GeneratorFunction')),
              (t.prototype = Object.create(f)),
              t
            );
          }
          return (
            ...
            pe(s, 'constructor', u),
            (u.displayName = 'GeneratorFunction'),
            pe(s, o, 'GeneratorFunction'),
            pe(f),
            pe(f, o, 'Generator'),
            pe(f, r, function () {
              return this;
            }),
            pe(f, 'toString', function () {
              return '[object Generator]';
            }),
            (fe = function () {
              return { w: i, m: p };
                ...
                return fe().w(function (e) {
                  for (;;)
                    switch (e.n) {
                      case 0:
                        if (
                          ((n = window.location.hash || '#/login'),
                          (r = document.getElementById('main-content')))
                        ) {
                          e.n = 1;
                          break;
                        }
                  ...
                  for (;;)
                    switch (n.n) {
                      case 0:
                        ...
                        break;
                      case 1:
                        return (n.n = 2), _.render();
                      case 2:
                        return (e.innerHTML = n.v), _.afterRender(), n.a(3, 15);
                      case 3:
                        return (n.n = 4), N.render();
                      case 4:
                        return (e.innerHTML = n.v), N.afterRender(), n.a(3, 15);
                      case 5:
                        if (h.isLoggedIn()) {
                          n.n = 6;
                          break;
                        }
                        return n.a(2, (location.hash = '#/login'));
                      case 6:
                        return (r = new It()), (n.n = 7), r.render();
                      case 7:
                        return (e.innerHTML = n.v), r.afterRender(), n.a(3, 15);
                      case 8:
                        if (h.isLoggedIn()) {
                          n.n = 9;
                          break;
                        ...
                        return n.a(2, (location.hash = '#/login'));
                      case 9:
                        return (n.n = 10), oe.render();
                      case 10:
                        return (
                          (e.innerHTML = n.v), oe.afterRender(), n.a(3, 15)
                        );
                      case 11:
                        if (h.isLoggedIn()) {
                          n.n = 12;
                        ...
                        return n.a(2, (location.hash = '#/login'));
                      case 12:
                        return (n.n = 13), le.render();
                      case 13:
                        return (
                          (e.innerHTML = n.v), le.afterRender(), n.a(3, 15)
                        );
                      case 14:
                        return (
                          (e.innerHTML =
        ...
        function he() {
          ...
          function p(t) {
            return (
              Object.setPrototypeOf
                ? Object.setPrototypeOf(t, s)
                : ((t.__proto__ = s), me(t, o, 'GeneratorFunction')),
              (t.prototype = Object.create(f)),
              t
            );
          }
                ...
                function (t) {
                  for (;;)
                    switch (t.n) {
                      ...
                      case 2:
                        return (
                          (t.p = 2), (t.n = 3), navigator.serviceWorker.ready
                        );
                      case 3:
                        return (
                          (e = t.v), (t.n = 4), e.pushManager.getSubscription()
                        );
                      case 4:
                        if (!t.v) {
                          t.n = 5;
                        ...
                        return (
                          console.log('🔔 Already subscribed to push'), t.a(2)
                        );
                      case 5:
                        return (
                          (t.n = 6),
                      ...
                      case 8:
                        (t.p = 8),
                          (r = t.v),
                          console.error('❌ Push Notification Error:', r),
                          alert('Failed to subscribe: ' + r.message);
                      case 9:
                        return t.a(2);
                    }
                  var o, i, a;
                ...
                function (t) {
                  for (;;)
                    switch (t.n) {
                      case 0:
                        return (
                          (t.p = 0), (t.n = 1), navigator.serviceWorker.ready
                        );
                      case 1:
                        return (
                          (e = t.v), (t.n = 2), e.pushManager.getSubscription()
                        );
                      case 2:
                        if (!(n = t.v)) {
                          t.n = 4;
                      ...
                      case 5:
                        (t.p = 5),
                          (r = t.v),
                          console.error('❌ Unsubscribe Error:', r),
                          alert('Failed to unsubscribe: ' + r.message);
                      case 6:
                        return t.a(2);
                    }
                },
        ...
        function _e() {
          ...
          function p(t) {
            return (
              Object.setPrototypeOf
                ? Object.setPrototypeOf(t, s)
                : ((t.__proto__ = s), Ge(t, o, 'GeneratorFunction')),
              (t.prototype = Object.create(f)),
              t
            );
          }
        ...
        function Ae(t) {
          return function () {
            ...
            return new Promise(function (r, o) {
              ...
              function c(t) {
                xe(i, r, o, a, c, 'throw', t);
              }
              a(void 0);
            });
          };
        }
        delete Le().Icon.Default.prototype._getIconUrl,
          Le().Icon.Default.mergeOptions({
            ...
            window.addEventListener('load', function () {
              navigator.serviceWorker.controller ||
                navigator.serviceWorker
                  ...
                  .then(function (t) {
                    console.log('✅ Service Worker registered:', t.scope), je();
                  })
                  .catch(function (t) {
            ...
            'dark' === localStorage.getItem('theme') &&
              ...
              (function () {
                var t = document.getElementById('subscribe-btn'),
                  e = document.getElementById('unsubscribe-btn');
                if (t && e) {
                  if (
                    !('serviceWorker' in navigator) ||
                    !('PushManager' in window)
                          ...
                          return _e().w(function (n) {
                            for (;;)
                              switch (n.n) {
                                ...
                                case 1:
                                  return (
                                    (n.n = 2), navigator.serviceWorker.ready
                                  );
                                case 2:
                                  return (
                                    (r = n.v),
  ...
  (r.m = e),
    ...
    (r.O = (e, n, o, i) => {
      if (!n) {
        ...
        for (l = 0; l < t.length; l++) {
          for (var [n, o, i] = t[l], c = !0, u = 0; u < n.length; u++)
            (!1 & i || a >= i) && Object.keys(r.O).every((t) => r.O[t](n[u]))
              ? n.splice(u--, 1)
              : ((c = !1), i < a && (a = i));
          if (c) {
            t.splice(l--, 1);
    ...
    (() => {
      ...
      var e = (e, n) => {
        ...
        n = (self.webpackChunkstory_day = self.webpackChunkstory_day || []);
      n.forEach(e.bind(null, 0)), (n.push = e.bind(null, n.push.bind(n)));
    })();
  var o = r.O(void 0, [443], () => r(259));
  o = r.O(o);
})();
//# sourceMappingURL=main.99aaf452d6794b79f431.js.map
