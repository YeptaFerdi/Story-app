/*! For license information please see main.97b9ffee60d1515c5ec0.js.LICENSE.txt */
(() => {
  'use strict';
  var t,
    r = {
      259: (t, r, e) => {
        ...
        function s() {
          ...
          return (
            ...
            l(b, 'constructor', v),
            l(v, 'constructor', y),
            (y.displayName = l(v, u, 'GeneratorFunction')),
                ...
                (function (r, e, n) {
                  ...
                  return function (i, a) {
                    ...
                    for (n.method = i, n.arg = a; ; ) {
                      ...
                      var s = l(r, e, n);
                      if ('normal' === s.type) {
                        if (((o = n.done ? 4 : 2), s.arg === f)) continue;
                        return { value: s.arg, done: n.done };
                      }
                      'throw' === s.type &&
                        ((o = 4), (n.method = 'throw'), (n.arg = s.arg));
          ...
          return (
            ...
            (j.prototype = {
              ...
              finish: function (t) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                  var e = this.tryEntries[r];
                  if (e[2] === t) return this.complete(e[4], e[3]), O(e), f;
                }
              },
              catch: function (t) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
          ...
          return (
            ...
            (S.prototype = {
              ...
              finish: function (t) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                  var e = this.tryEntries[r];
                  if (e[2] === t) return this.complete(e[4], e[3]), k(e), f;
                }
              },
              catch: function (t) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                    ...
                    case 0:
                      return (
                        ...
                        t.abrupt(
                          ...
                          (0, F.P2)('story-db', 1, {
                            upgrade: function (t) {
                              t.objectStoreNames.contains(C) ||
                                (console.log('🆕 Creating object store:', C),
                                t.createObjectStore(C, { keyPath: 'id' }));
                            },
                          })
                        )
                      );
                  ...
                  function (r) {
                    for (;;)
                      switch ((r.prev = r.next)) {
                        ...
                        case 3:
                          return (e = r.sent), (r.next = 6), e.put(C, t);
                        case 6:
                  ...
                  function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 3:
                          return (r = t.sent), (t.next = 6), r.getAll(C);
                        case 6:
                          return (
                            (e = t.sent),
                    ...
                    for (;;)
                      switch ((r.prev = r.next)) {
                        case 0:
                          return (r.prev = 0), (r.next = 3), U();
                        case 3:
                          return (e = r.sent), (r.next = 6), e.delete(C, t);
                        case 6:
                          console.log(
                    ...
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (t.prev = 0), (t.next = 3), U();
                        case 3:
                          return (r = t.sent), (t.next = 6), r.clear(C);
                        case 6:
          ...
          function b(t, r) {
            function e(o, i, a, u) {
              ...
              if ('throw' !== c.type) {
                var s = c.arg,
                  f = s.value;
                return f && 'object' == lt(f) && n.call(f, '__await')
                  ? r.resolve(f.__await).then(
                      function (t) {
                        e('next', t, a, u);
                      },
                  ...
                  value: function (t) {
                    var r = t
                        .map(function (t) {
                          ...
                          return (
                            t.imageBlob &&
                              (r = URL.createObjectURL(t.imageBlob)),
                            '\n        <div class="story-card" tabindex="0" aria-label="Story by '
                              .concat(t.uploader, ' on ')
                              .concat(t.createdAt, '">\n          <img src="')
                              .concat(
                                r,
                                '" alt="Story photo" onload="this.dataset.blobUrl && URL.revokeObjectURL(this.dataset.blobUrl)" data-blob-url="'
                              )
                              .concat(t.imageBlob ? r : '', '">\n          <p>')
                              .concat(
                                t.description,
            ...
            return (function (t, r, e) {
              ...
              [
                ...
                },
                {
                  key: 'takePicture',
                  value: function () {
                    var t = Pt(Ft, this).getContext('2d'),
                    ...
                    return r && e
                      ? ((Pt(Ft, this).width = r),
                        ...
                        Pt(Ft, this).toDataURL('image/jpeg'))
                      : null;
                  },
                },
              ],
        ...
        function Dt() {
          var t = Pt(Ft, this).getContext('2d');
          (t.fillStyle = '#ccc'),
            t.fillRect(0, 0, Pt(Ft, this).width, Pt(Ft, this).height);
        }
        function Ht(t) {
          return (
            (Ht =
          ...
          function b(t, r) {
            function e(o, i, a, u) {
              ...
              if ('throw' !== c.type) {
                var s = c.arg,
                  f = s.value;
                return f && 'object' == zt(f) && n.call(f, '__await')
                  ? r.resolve(f.__await).then(
                      function (t) {
                        e('next', t, a, u);
                      },
                ...
                return Jt().wrap(function (r) {
                  for (;;)
                    switch ((r.prev = r.next)) {
                      case 0:
                        return (
                          (n = document.getElementById('story-list')),
                          (r.next = 3),
                          W()
                        );
                      case 3:
                        ...
                        return (
                          (n.innerHTML = '<p>No stories saved offline.</p>'),
                          r.abrupt('return')
                        );
                      case 8:
                        o.forEach(function (r) {
                          var e = document.createElement('article');
                          e.className = 'story-card horizontal-card';
                          var o = document.createElement('img');
                          if (((o.alt = 'Story photo'), r.imageBlob)) {
                            var i = URL.createObjectURL(r.imageBlob);
                            (o.src = i),
                              (o.onload = function () {
                                return URL.revokeObjectURL(i);
                              });
                          } else r.image ? (o.src = r.image) : (o.src = 'fallback.jpg');
                          ...
                          null ===
                            (e = document.getElementById('clear-all-btn')) ||
                            void 0 === e ||
                            e.addEventListener(
                              'click',
                              Kt(
          ...
          function b(t, r) {
            function e(o, i, a, u) {
              ...
              if ('throw' !== c.type) {
                var s = c.arg,
                  f = s.value;
                return f && 'object' == gr(f) && n.call(f, '__await')
                  ? r.resolve(f.__await).then(
                      function (t) {
                        e('next', t, a, u);
                      },
            ...
            window.addEventListener('load', function () {
              navigator.serviceWorker.controller ||
                navigator.serviceWorker
                  ...
                  .then(function (t) {
                    console.log('✅ Service Worker registered:', t.scope), fr();
                  })
                  .catch(function (t) {
    ...
    (n.O = (r, e, o, i) => {
      if (!e) {
        ...
        for (l = 0; l < t.length; l++) {
          for (var [e, o, i] = t[l], u = !0, c = 0; c < e.length; c++)
...
//# sourceMappingURL=main.97b9ffee60d1515c5ec0.js.map
